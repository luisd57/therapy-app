...
- [x] Existing specs updated for the Modality flow that ticket 05 reshapes (done in PR #39, which updated `slot-browser.spec.ts`, `next-available-week.spec.ts` and `fixtures/helpers.ts` for it)
